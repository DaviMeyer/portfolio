        ...
        <section id="cv" className="py-24 px-6 max-w-4xl mx-auto z-10 relative">
            ...
            >
                {timelineData.map((item) => (
                    ...
                    >
                        <span className={`absolute -left-[5px] top-2 h-[11px] w-[11px] rounded-full bg-slate-950 border-2 border-transparent bg-gradient-to-br from-${theme.tailwind}-500 to-${theme.secondary}-500 z-10 shadow-[0_0_10px_rgba(255,255,255,0.2)]`}></span>
