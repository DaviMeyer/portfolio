...
const projectsData: ProjectItem[] = [
    {
        ...
        icon: <Train className="w-10 h-10 text-orange-400" />,
                ...
                >
                    {projectsData.map((project) => (
                        <motion.a
                            ...
                            className="block p-8 rounded-2xl bg-gradient-to-br from-slate-800/40 to-slate-900/40 border border-white/5 hover:border-orange-500/30 group backdrop-blur-sm transition-all relative overflow-hidden"
                        >
                            <div className="absolute top-4 right-4 text-slate-500 group-hover:text-orange-400 transition-colors">
                                <ExternalLink className="w-5 h-5" />
                            </div>

                            <div className="flex items-start gap-4 mb-6">
                                <div className="p-3 rounded-xl bg-slate-800/50 text-white group-hover:text-orange-400 transition-colors">
                                    {project.icon}
                                </div>
                                <div>
